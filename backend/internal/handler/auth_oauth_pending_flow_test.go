...
import (
	...
	"github.com/silent-QAQ/redstoneapi/ent/authidentity"
	"github.com/silent-QAQ/redstoneapi/ent/enttest"
	"github.com/silent-QAQ/redstoneapi/ent/identityadoptiondecision"
	"github.com/silent-QAQ/redstoneapi/ent/pendingauthsession"
	"github.com/silent-QAQ/redstoneapi/ent/redeemcode"
	dbuser "github.com/silent-QAQ/redstoneapi/ent/user"
...
CREATE TABLE IF NOT EXISTS user_affiliates (
	...
	if options.promoRepo != nil {
		...
		promoService.SetRedstoneWalletPort(oauthPendingWalletPort{})
	}
	...
	authSvc.SetRedstoneWalletPort(oauthPendingWalletPort{})
...
// oauthPendingWalletPort is a SQLite-only fixture for HTTP flow tests. The
// production application wires the PostgreSQL ledger adapter; this keeps the
// test focused on OAuth state transitions while preserving the command-only
// wallet interface at every application call site.
type oauthPendingWalletPort struct{}

func (oauthPendingWalletPort) Credit(context.Context, service.RedstoneWalletCreditCommand) error {
	return nil
}

func (oauthPendingWalletPort) CreditInExecutor(ctx context.Context, executor service.RedstoneWalletExecutor, command service.RedstoneWalletCreditCommand) error {
...
func (oauthPendingWalletPort) AdjustNormal(context.Context, service.RedstoneWalletAdjustmentCommand) error {
	return nil
}

func (oauthPendingWalletPort) AdjustNormalInExecutor(ctx context.Context, executor service.RedstoneWalletExecutor, command service.RedstoneWalletAdjustmentCommand) error {
	...
	if affected != 1 {
		return errors.New("test wallet insufficient balance or user missing")
	}
	return nil
}

func (oauthPendingWalletPort) DeductNormalAvailable(context.Context, service.RedstoneWalletAdjustmentCommand) (float64, error) {
	return 0, nil
}

func (oauthPendingWalletPort) DeductNormalAvailableInExecutor(context.Context, service.RedstoneWalletExecutor, service.RedstoneWalletAdjustmentCommand) (float64, error) {
	return 0, nil
}

func (oauthPendingWalletPort) SetNormal(context.Context, service.RedstoneWalletSetNormalCommand) error {
	return nil
}

func (oauthPendingWalletPort) ChargeToken(context.Context, service.RedstoneWalletTokenChargeCommand) (service.RedstoneWalletTokenChargeResult, error) {
	return service.RedstoneWalletTokenChargeResult{}, nil
}

func (oauthPendingWalletPort) ChargeTokenInExecutor(context.Context, service.RedstoneWalletExecutor, service.RedstoneWalletTokenChargeCommand) (service.RedstoneWalletTokenChargeResult, error) {
	return service.RedstoneWalletTokenChargeResult{}, nil
}
