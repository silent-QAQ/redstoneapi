...
import (
	...
	"github.com/silent-QAQ/redstoneapi/internal/domain"
	"github.com/silent-QAQ/redstoneapi/internal/pkg/antigravity"
	"github.com/silent-QAQ/redstoneapi/internal/pkg/claude"
	"github.com/silent-QAQ/redstoneapi/internal/pkg/ctxkey"
	pkgerrors "github.com/silent-QAQ/redstoneapi/internal/pkg/errors"
...
// SetAvailableModelsCacheEpochReader connects the gateway's local model cache
// to the optional Redstone cluster control plane.
func (h *GatewayHandler) SetAvailableModelsCacheEpochReader(reader service.GatewayCacheEpochReader) {
	if h == nil || h.gatewayService == nil {
		return
	}
	h.gatewayService.SetAvailableModelsCacheEpochReader(reader)
}
