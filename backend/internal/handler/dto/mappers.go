...
func APIKeyFromService(k *service.APIKey) *APIKey {
	...
	out := &APIKey{
		...
		Name:                      k.Name,
		GroupID:                   k.GroupID,
		SharingRoomID:             k.SharingRoomID,
		SharingRoomRateMultiplier: k.SharingRoomRateMultiplier,
		Status:                    k.Status,
...
func groupFromServiceBase(g *service.Group) Group {
	return Group{
		...
		AllowedOpenAIAccountLevels:      append([]string(nil), g.AllowedOpenAIAccountLevels...),
		RPMLimit:                        g.RPMLimit,
