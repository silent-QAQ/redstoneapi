...
var auditActionOverrides = map[string]string{
	...
	"POST /api/v1/admin/redstone/cluster/nodes/:node_id/drain":                "admin.redstone.cluster.node.drain",
	"POST /api/v1/admin/redstone/cluster/nodes/:node_id/resume":               "admin.redstone.cluster.node.resume",
	"POST /api/v1/admin/redstone/cluster/cache-epochs/:cache_name/invalidate": "admin.redstone.cluster.cache.invalidate",
}
...
var auditBodyOmittedRoutes = map[string]struct{}{
	...
	"POST /api/v1/user/controlled-accounts":                      {},
	"POST /api/v1/user/accounts":                                 {},
	"PUT /api/v1/user/accounts/:id":                              {},
	"POST /api/v1/user/accounts/data":                            {},
	"POST /api/v1/user/accounts/batch":                           {},
	"POST /api/v1/user/accounts/batch-update-credentials":        {},
	"POST /api/v1/user/accounts/import/codex-session":            {},
	"POST /api/v1/user/accounts/:id/apply-oauth-credentials":     {},
	"POST /api/v1/user/accounts/generate-auth-url":               {},
	"POST /api/v1/user/accounts/generate-setup-token-url":        {},
	"POST /api/v1/user/accounts/exchange-code":                   {},
	"POST /api/v1/user/accounts/exchange-setup-token-code":       {},
	"POST /api/v1/user/accounts/cookie-auth":                     {},
	"POST /api/v1/user/accounts/setup-token-cookie-auth":         {},
	"POST /api/v1/user/accounts/openai/generate-auth-url":        {},
	"POST /api/v1/user/accounts/openai/exchange-code":            {},
	"POST /api/v1/user/accounts/openai/refresh-token":            {},
	"POST /api/v1/user/accounts/gemini/oauth/auth-url":           {},
	"POST /api/v1/user/accounts/gemini/oauth/exchange-code":      {},
	"POST /api/v1/user/accounts/antigravity/oauth/auth-url":      {},
	"POST /api/v1/user/accounts/antigravity/oauth/exchange-code": {},
	"POST /api/v1/user/accounts/antigravity/oauth/refresh-token": {},
	"POST /api/v1/user/accounts/grok/oauth/auth-url":             {},
	"POST /api/v1/user/accounts/grok/oauth/exchange-code":        {},
	"POST /api/v1/user/accounts/grok/oauth/refresh-token":        {},
	"POST /api/v1/user/accounts/grok/oauth/sso-token":            {},
	"POST /api/v1/user/accounts/grok/oauth/password":             {},
	"POST /api/v1/user/accounts/grok/sso-to-oauth":               {},
