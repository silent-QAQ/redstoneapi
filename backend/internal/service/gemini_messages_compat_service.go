...
import (
	...
	"github.com/silent-QAQ/redstoneapi/internal/pkg/googleapi"
...
// SetSharingAccessGuard installs Redstone's account-level lease guard.
func (s *GeminiMessagesCompatService) SetSharingAccessGuard(guard SharingAccessGuard) {
	if s != nil {
...
func (s *GeminiMessagesCompatService) listSchedulableAccountsOnce(ctx context.Context, groupID *int64, platform string, hasForcePlatform bool) ([]Account, error) {
	if s.schedulerSnapshot != nil {
		...
		return filterAccountsForSharingAccess(ctx, s.sharingAccessGuard, accounts)
	}
