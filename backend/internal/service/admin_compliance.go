...
const (
	...
	AdminComplianceDocumentURLZH  = "https://github.com/silent-QAQ/redstoneapi/blob/main/docs/legal/admin-compliance.zh.md"
	AdminComplianceDocumentURLEN  = "https://github.com/silent-QAQ/redstoneapi/blob/main/docs/legal/admin-compliance.en.md"
