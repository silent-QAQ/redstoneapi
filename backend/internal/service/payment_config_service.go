...
// GetBalanceRechargeMultiplier exposes the configured ordinary-balance credit
// rate to policy consumers. It intentionally reuses the same normalization as
// the payment fulfillment path.
func (s *PaymentConfigService) GetBalanceRechargeMultiplier(ctx context.Context) (float64, error) {
