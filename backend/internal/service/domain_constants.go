...
const (
	...
	// RedeemTypeBoundBalance creates non-withdrawable, token-only balance.
	// It is intentionally a distinct code type so historical balance codes
	// remain ordinary balance credits.
	RedeemTypeBoundBalance     = "bound_balance"
