...
const apiKeyAuthSnapshotVersion = 21 // v21: room-mode pricing snapshot (force refresh of pre-fix snapshots)
...
func (s *APIKeyService) snapshotFromAPIKey(ctx context.Context, apiKey *APIKey) *APIKeyAuthSnapshot {
	...
	snapshot := &APIKeyAuthSnapshot{
		...
		SharingRoomID:             apiKey.SharingRoomID,
		SharingRoomRateMultiplier: apiKey.SharingRoomRateMultiplier,
		Name:                      apiKey.Name,
...
func (s *APIKeyService) snapshotToAPIKey(key string, snapshot *APIKeyAuthSnapshot) *APIKey {
	...
	apiKey := &APIKey{
		...
		SharingRoomID:             snapshot.SharingRoomID,
		SharingRoomRateMultiplier: snapshot.SharingRoomRateMultiplier,
		Key:                       key,
		Name:                      snapshot.Name,
