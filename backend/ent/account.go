...
type Account struct {
	...
	// AccountLevel holds the value of the "account_level" field.
...
func (*Account) scanValues(columns []string) ([]any, error) {
	...
	for i := range columns {
		...
		case account.FieldName, account.FieldNotes, account.FieldPlatform, account.FieldAccountLevel, account.FieldType, account.FieldStatus, account.FieldErrorMessage, account.FieldTempUnschedulableReason, account.FieldSessionWindowStatus, account.FieldQuotaDimension:
