...
import (
	...
	_ "github.com/silent-QAQ/redstoneapi/ent/runtime"
	...
	"github.com/silent-QAQ/redstoneapi/internal/setup"
...
func runMainServer() {
	...
	// 启动账号验真调度器
	if app.ControlledAccountHandler != nil {
		ctx := context.Background()
		app.ControlledAccountHandler.Start(ctx)
		log.Println("Account verification scheduler started")
	}
